...
The method returns the pared-down \ARGV array.
...
Option-defining methods allow you to create an option and also append or prepend it
to either the top list or the base list.
