...
You may create custom argument converters.
To do so, call OptionParser#accept with a class argument
and a block that converts the argument and returns the converted value.

  :include: custom_converters.rb
